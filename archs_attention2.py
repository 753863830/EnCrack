...
class VGGBlock(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels):
        ...
        self.conv1 = nn.Conv2d(in_channels, middle_channels, 3, padding=1) #dilation = 2
...
class NestedUNet(nn.Module):
    ...
    def __init__(self, num_classes, input_channels=3, deep_supervision=False, **kwargs):
        ...
        self.attention1 = AttentionBlock(nb_filter[0], nb_filter[1], nb_filter[0])
        self.attention2 = AttentionBlock(nb_filter[1], nb_filter[2], nb_filter[1])
        self.attention3 = AttentionBlock(nb_filter[2], nb_filter[3], nb_filter[2])
        self.attention4 = AttentionBlock(nb_filter[3], nb_filter[4], nb_filter[3])
